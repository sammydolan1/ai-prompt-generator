...
if theme == "Dark Mode":
    st.markdown(
        ...
        <style>
            ...
            .st-emotion-cache-pkbazv, st-emotion-cache-1mqbigv, .stRadio, label, .css-1aumxhk, .e1icttdg0 { color: #FFF !important; }
    ...
    st.markdown(
        ...
        <style>
            ...
            /* Style for sidebar text */
            .stSidebar, .st-emotion-cache-16txtl3, .st-emotion-cache-1vbkxwb, 
            .st-emotion-cache-pkbazv, st-emotion-cache-1mqbigv, .stRadio, label, .css-1aumxhk .e1icttdg0 { color: #000 !important; }
